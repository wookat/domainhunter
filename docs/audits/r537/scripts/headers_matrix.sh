#!/usr/bin/env bash
# R537 security header matrix against production (0 AI). Output: headers/<name>.h + matrix.tsv
set -u
O=https://hunt.zalize.com
UA="Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0 Safari/537.36 r537-audit"
mkdir -p /home/ubuntu/r537/headers
cd /home/ubuntu/r537
CB=$RANDOM$RANDOM
...
add nf_shell "/does-not-exist-r537?cb=$CB" GET
add s_nf "/s/nope-r537?cb=$CB" GET
...
add api_nf "/api/nope-r537?cb=$CB" GET
...
add nope_png "/nope-r537.png" GET
