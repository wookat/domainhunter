...
mkdir -p /home/ubuntu/r558/headers
cd /home/ubuntu/r558
CB=$RANDOM$RANDOM
...
add nf_shell "/does-not-exist-r558?cb=$CB" GET
add s_nf "/s/nope-r558?cb=$CB" GET
...
add api_nf "/api/nope-r558?cb=$CB" GET
...
add nope_png "/nope-r558.png" GET
