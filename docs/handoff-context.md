...
> **最后更新：2026-09-06 13:20 UTC（R541，同步到 R535–R539 上线 version 0358b278 + R537 审计 + R540 回归）**。上一次 2026-09-06 11:45（R534，version d4f1336a）、10:15（R529，version f648963f）、07:40（R523，version d8e5038b）。上一次系统性更新 2026-09-04（R490）。上一次系统性更新是 R250（2026-08-08），R466–R485 期间只做过局部小节追加（`git log -- docs/handoff-context.md`：e7bbfcb R481、a248e48 R482、79ecd0b R485）。
...
## 5. 当前实时服务状态（2026-09-06 13:00 UTC 实查）

| 项 | 值 | 证据 |
|---|---|---|
| 线上地址 | https://hunt.zalize.com （自定义域）；Worker 直连 https://domainhunter.wookat520.workers.dev | 首页 200 |
| 生产 Worker version | **`0358b278-f0a1-4736-a664-d012cac3b40e`**（deployed 2026-09-06T~12:50Z，含 R501–R539；R538 `_headers` 使 Assets 层静态文件也带 nosniff + Referrer-Policy）；前一版 `d4f1336a` ~11:10Z 含至 R533，`f648963f` 09:58Z 含至 R528，`25d23c2a` 08:59Z 含至 #492（R525/R528），`d8e5038b` 07:12Z 含至 R522 | `npx wrangler deployments list`（apps/web） |
| 对应代码 tip | `deploy/r192-r195` @ **5078d73**（R539 #505 合并提交；本批依次合并 #501 R538 → #502 R536 → #503 R535 → #504 R537 docs → #505 R539，四条本地验收命令全绿：typecheck / 34 files 402 tests / build / content-counts，另 `check-static-prices --live` 首年偏差 >30% = 0）；零 AI 生产回归证据 https://github.com/wookat/domainhunter/pull/503#issuecomment-5559485087 （R535–R539 一次覆盖，报告 `docs/qa/r540-regression.md`）；上一轮 #499 评论 https://github.com/wookat/domainhunter/pull/499#issuecomment-5558922767 （R530–R533，报告 `docs/qa/r534-regression.md`）；上一轮 #494 评论 https://github.com/wookat/domainhunter/pull/494#issuecomment-5558480170 （报告 `docs/qa/r528-regression.md`）；上一轮 #486 评论 https://github.com/wookat/domainhunter/pull/486#issuecomment-5557768553 | R510 生产复验 https://github.com/wookat/domainhunter/pull/475#issuecomment-5553032616 ；R509 零 AI 回归 https://github.com/wookat/domainhunter/pull/471#issuecomment-5552746476 |
