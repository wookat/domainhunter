...
const TLD_CATEGORY_DEFS: { id: string; zh: string; en: string; members: string[] }[] = [
  { id: "general", zh: "通用主流", en: "General & mainstream", members: ["com", "net", "org", "co", "me", "info", "pro", "one", "top", "xyz", "icu", "link", "click", "best", "today", "cool", "plus", "website", "help"] },
  ...
  { id: "creative", zh: "创意与设计", en: "Creative & design", members: ["art", "design", "studio", "ink", "moe", "lol", "wtf", "red", "page", "bio", "photos", "gallery", "photography", "style", "fashion", "beauty", "photo"] },
  { id: "media", zh: "内容与媒体", en: "Content & media", members: ["blog", "news", "media", "video", "tv", "fm", "chat", "social", "email", "live", "band", "watch", "show", "community", "guide", "reviews", "fyi", "press", "stream", "movie", "pictures", "productions", "audio"] },
  { id: "commerce", zh: "商业与电商", en: "Business & commerce", members: ["shop", "store", "online", "site", "company", "group", "agency", "team", "works", "center", "global", "expert", "boutique", "solutions", "services", "consulting", "marketing", "guru", "tips", "directory", "international", "partners", "market", "work", "sale", "law", "tax", "shoes", "toys", "gifts", "ltd", "biz", "llc", "promo", "express"] },
  { id: "finance", zh: "金融与资产", en: "Finance & assets", members: ["finance", "fund", "money", "cash", "gold", "estate", "land", "ventures", "capital", "exchange", "properties", "rentals", "apartments", "credit", "loans", "investments", "holdings", "mortgage"] },
  { id: "lifestyle", zh: "生活与行业", en: "Lifestyle & industries", members: ["life", "world", "club", "vip", "space", "fun", "games", "pizza", "bar", "cafe", "restaurant", "city", "farm", "academy", "school", "coach", "care", "doctor", "clinic", "dental", "fitness", "salon", "yoga", "coffee", "wine", "kitchen", "garden", "events", "institute", "house", "education", "training", "love", "wedding", "menu", "bike", "travel", "tours", "vacations", "holiday", "flights", "taxi", "builders", "construction", "repair", "energy", "solar", "green", "eco", "earth", "engineering", "family", "baby", "mom", "dad", "dog", "health", "fit", "dance", "golf", "tennis", "soccer", "football", "hockey", "surf"] },
