...
const TLD_CATEGORY_DEFS: { id: string; zh: string; en: string; members: string[] }[] = [
  ...
  { id: "finance", zh: "金融与资产", en: "Finance & assets", members: ["finance", "fund", "money", "cash", "gold", "estate", "land", "ventures", "capital", "exchange", "properties", "rentals", "apartments", "credit", "loans", "investments", "holdings", "mortgage", "rent", "homes", "casa", "bond", "immo"] },
