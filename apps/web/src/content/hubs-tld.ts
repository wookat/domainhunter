...
const TLD_CATEGORY_DEFS: { id: string; zh: string; en: string; members: string[] }[] = [
  ...
  { id: "creative", zh: "创意与设计", en: "Creative & design", members: ["art", "design", "studio", "ink", "moe", "lol", "wtf", "red", "page", "bio", "photos", "gallery", "photography", "style", "fashion", "beauty", "photo", "hair", "skin", "makeup", "camera"] },
  ...
  { id: "commerce", zh: "商业与电商", en: "Business & commerce", members: ["shop", "store", "online", "site", "company", "group", "agency", "team", "works", "center", "global", "expert", "boutique", "solutions", "services", "consulting", "marketing", "guru", "tips", "directory", "international", "partners", "market", "work", "sale", "law", "tax", "shoes", "toys", "gifts", "ltd", "biz", "llc", "promo", "express", "lawyer", "legal", "delivery", "jewelry", "careers", "management", "equipment", "supply", "parts", "auction", "deals", "coupons", "discount", "business", "limited", "associates", "cheap", "bargains", "supplies", "diamonds", "accountants"] },
