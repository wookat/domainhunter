...
const TLD_CATEGORY_DEFS: { id: string; zh: string; en: string; members: string[] }[] = [
  ...
  { id: "creative", zh: "创意与设计", en: "Creative & design", members: ["art", "design", "studio", "ink", "moe", "lol", "wtf", "red", "page", "bio", "photos", "gallery", "photography", "style", "fashion", "beauty", "photo", "hair", "skin", "makeup", "camera", "clothing"] },
