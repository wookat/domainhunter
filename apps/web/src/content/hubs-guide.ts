...
const GUIDE_CATEGORY_DEFS: { id: string; zh: string; en: string; members: string[] }[] = [
  ...
  { id: "food", zh: "餐饮与食品", en: "Food & beverage", members: ["food", "coffee", "bakery", "brewery", "farm", "foodtruck", "mealprep", "bar", "hotpot", "dessert", "noodle", "teahouse", "bubbletea", "bbq", "catering", "fruitshop", "seafood", "deli", "winery", "sushi", "icecream", "tea", "pizza"] },
  ...
  { id: "business", zh: "商业与专业服务", en: "Business & professional", members: ["fintech", "legal", "accounting", "insurance", "recruiting", "realestate", "agency", "freelance", "marketing", "coworking", "resume", "nonprofit", "community", "game", "esports", "careercoach", "vr", "cybercafe", "realtor", "propertymgmt", "equipmentrental", "retrofit", "watertreatment", "companyreg", "consulting", "immigration", "securityguard", "ipagency", "ticketing"] },
];
