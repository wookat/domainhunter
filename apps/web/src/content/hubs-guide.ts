...
const GUIDE_CATEGORY_DEFS: { id: string; zh: string; en: string; members: string[] }[] = [
  ...
  { id: "food", zh: "餐饮与食品", en: "Food & beverage", members: ["food", "coffee", "bakery", "brewery", "farm", "foodtruck", "mealprep", "bar", "hotpot", "dessert", "noodle", "teahouse", "bubbletea", "bbq", "catering"] },
  ...
  { id: "health", zh: "健康与运动", en: "Health & fitness", members: ["fitness", "health", "yoga", "coach", "crossfit", "therapy", "dental", "eldercare", "ski", "climbing", "martialarts", "billiards", "massage", "diving", "skateshop", "surf", "golf", "pharmacy", "clinic", "nutrition", "physio", "runclub", "tennis", "soccer", "football", "hockey", "pickleball", "pilates"] },
  { id: "travel", zh: "旅行与出行", en: "Travel & mobility", members: ["travel", "bnb", "outdoor", "automotive", "moving", "logistics", "rvtravel", "bikeshop", "fishing", "campgear", "carrental", "travelagency", "hotel", "towing"] },
  { id: "local", zh: "生活服务", en: "Local services", members: ["pets", "vet", "aquarium", "cleaning", "barber", "beauty", "wedding", "florist", "gardening", "interior", "events", "escaperoom", "parenting", "pettraining", "nailsalon", "laundry", "matchmaking", "tattoo", "repair", "optician", "carwash", "petboarding", "locksmith", "printshop", "errand", "plumber", "petcafe", "footspa", "parcel", "apartment", "construction", "appliancerepair", "karaoke", "hvac", "recycling", "petgrooming", "housekeeping", "kidsplayground", "pestcontrol", "roofing", "selfstorage", "signage"] },
  { id: "business", zh: "商业与专业服务", en: "Business & professional", members: ["fintech", "legal", "accounting", "insurance", "recruiting", "realestate", "agency", "freelance", "marketing", "coworking", "resume", "nonprofit", "community", "game", "esports", "careercoach", "vr", "cybercafe", "realtor", "propertymgmt", "equipmentrental", "retrofit", "watertreatment", "companyreg", "consulting"] },
];
