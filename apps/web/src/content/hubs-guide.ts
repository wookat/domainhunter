...
const GUIDE_CATEGORY_DEFS: { id: string; zh: string; en: string; members: string[] }[] = [
  { id: "tech", zh: "科技与互联网", en: "Tech & internet", members: ["saas", "ai", "agent", "devtools", "web3", "security", "hardware", "opensource", "indiehacker", "indiegame", "drone", "solar", "3dprint", "evcharging", "energystorage"] },
  { id: "ecommerce", zh: "电商与零售", en: "E-commerce & retail", members: ["ecommerce", "crossborder", "livestream", "resale", "fleamarket", "sourcing", "forwarder", "usedcar", "fashion", "jewelry", "toys", "furniture", "hanfu", "petsupplies", "gearrental", "vending", "fragrance", "upcycling", "convenience", "stationery", "grocery", "babystore", "giftcustom", "wholesale", "trading", "coupon", "flashsale"] },
  { id: "food", zh: "餐饮与食品", en: "Food & beverage", members: ["food", "coffee", "bakery", "brewery", "farm", "foodtruck", "mealprep", "bar", "hotpot", "dessert", "noodle", "teahouse", "bubbletea", "bbq", "catering", "fruitshop", "seafood", "deli", "winery", "sushi", "icecream"] },
  { id: "content", zh: "内容与创作", en: "Content & creators", members: ["blog", "podcast", "newsletter", "creator", "music", "photography", "travelshoot", "mcn", "boardgame", "pottery", "petphoto", "zine", "weddingphoto", "kidsphoto", "productphoto", "portrait", "foodreview", "shortvideo", "audiobook", "postproduction", "animation", "documentary", "newsmedia"] },
  ...
  { id: "health", zh: "健康与运动", en: "Health & fitness", members: ["fitness", "health", "yoga", "coach", "crossfit", "therapy", "dental", "eldercare", "ski", "climbing", "martialarts", "billiards", "massage", "diving", "skateshop", "surf", "golf", "pharmacy", "clinic", "nutrition", "physio", "runclub", "tennis", "soccer", "football", "hockey", "pickleball", "pilates", "equestrian", "archery", "bowling"] },
  { id: "travel", zh: "旅行与出行", en: "Travel & mobility", members: ["travel", "bnb", "outdoor", "automotive", "moving", "logistics", "rvtravel", "bikeshop", "fishing", "campgear", "carrental", "travelagency", "hotel", "towing", "hostel"] },
  { id: "local", zh: "生活服务", en: "Local services", members: ["pets", "vet", "aquarium", "cleaning", "barber", "beauty", "wedding", "florist", "gardening", "interior", "events", "escaperoom", "parenting", "pettraining", "nailsalon", "laundry", "matchmaking", "tattoo", "repair", "optician", "carwash", "petboarding", "locksmith", "printshop", "errand", "plumber", "petcafe", "footspa", "parcel", "apartment", "construction", "appliancerepair", "karaoke", "hvac", "recycling", "petgrooming", "housekeeping", "kidsplayground", "pestcontrol", "roofing", "selfstorage", "signage", "tailor"] },
  { id: "business", zh: "商业与专业服务", en: "Business & professional", members: ["fintech", "legal", "accounting", "insurance", "recruiting", "realestate", "agency", "freelance", "marketing", "coworking", "resume", "nonprofit", "community", "game", "esports", "careercoach", "vr", "cybercafe", "realtor", "propertymgmt", "equipmentrental", "retrofit", "watertreatment", "companyreg", "consulting", "immigration"] },
];
