...
const GUIDE_CATEGORY_DEFS: { id: string; zh: string; en: string; members: string[] }[] = [
  ...
  { id: "ecommerce", zh: "电商与零售", en: "E-commerce & retail", members: ["ecommerce", "crossborder", "livestream", "resale", "fleamarket", "sourcing", "forwarder", "usedcar", "fashion", "jewelry", "toys", "furniture", "hanfu", "petsupplies", "gearrental", "vending", "fragrance", "upcycling", "convenience", "stationery"] },
  { id: "food", zh: "餐饮与食品", en: "Food & beverage", members: ["food", "coffee", "bakery", "brewery", "farm", "foodtruck", "mealprep", "bar", "hotpot", "dessert"] },
