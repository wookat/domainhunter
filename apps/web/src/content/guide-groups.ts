...
const GUIDE_CATEGORY_DEFS: { id: string; zh: string; en: string; members: string[] }[] = [
  ...
  /* .cn 合规与流程（guides-cn-compliance.ts）：实名/serverHold/备案/解析/注册商/到期，互链自成一组 */
  { id: "compliance", zh: "合规与流程", en: "Compliance & process", members: ["cn-realname", "cn-serverhold", "cn-icp-beian", "cn-dns-inland-vs-overseas", "cn-vs-comcn-registrar", "cn-expiry-redemption"] },
];
