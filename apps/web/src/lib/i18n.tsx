...
const zh = {
  ...
  "adv.comboHint": "填词根，可选前缀/后缀，按 TLD 展开成候选后逐个核验；TLD 同时决定下方裸名字的展开方式",
  "adv.roots": "词根（roots）",
...
const en: Record<I18nKey, string> = {
  ...
  "adv.comboHint": "Enter roots, optional prefixes/suffixes; candidates are expanded per TLD and checked one by one. The TLDs also drive how bare names below are expanded",
  "adv.roots": "Roots",
