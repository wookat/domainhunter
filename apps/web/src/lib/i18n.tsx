...
const en: Record<I18nKey, string> = {
  ...
  "home.subtitle": "Describe your idea — AI brainstorms names in bulk, verifies them live, and scores each one. You only ever see names you can register right now.",
